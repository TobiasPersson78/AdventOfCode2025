...
Console.WriteLine($"Rolls of paper immediately accessable by forklift: {rollsRemovedCount.First()}"); // 13, 1489

Console.WriteLine("Day 4B");
Console.WriteLine($"Rolls of paper accessable by forklift after removals: {rollsRemovedCount.Sum()}"); // 43, 8890
